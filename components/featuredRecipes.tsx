    ...
    <section className="py-20 px-6 bg-gradient-to-br from-orange-50 via-white to-red-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="inline-block px-6 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white text-sm font-bold rounded-full uppercase tracking-wider mb-4 shadow-lg">
            Discover
          </span>
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 text-gray-900 tracking-tight">
            Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600">Recipes</span>
          </h2>
